  ...
  return (
    <div className="min-h-screen bg-[var(--paper)] flex">
      ...
      <aside className="hidden md:flex flex-col w-52 border-r border-line bg-white fixed top-0 left-0 h-full z-20">
        ...
        <div className="m-3 rounded-xl border border-line p-4">
          <p className="text-[10px] font-bold text-[var(--muted)] mb-0.5 uppercase tracking-wide">You&apos;re a brand</p>
          <p className="text-xs text-ink">Are you a creator?</p>
          <Link
            href="/dashboard"
            className="mt-3 w-full bg-[var(--paper-2)] hover:bg-[var(--line)] text-ink rounded-lg py-2 text-xs font-semibold transition-colors flex items-center justify-center"
          >
            Switch to creator view
          </Link>
        </div>
